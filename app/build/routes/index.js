...
exports.notAuthRoutes = exports.appRouter = void 0;
...
const googleAuthRouter_1 = __importDefault(require("./auth/googleAuthRouter"));
...
function notAuthRoutes(app) {
    ...
    router.use('/auth/google', googleAuthRouter_1.default);
}
exports.notAuthRoutes = notAuthRoutes;
